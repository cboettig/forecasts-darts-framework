...
temp_POSE  = aquatics.query("site_id == 'POSE'").filter(items=['datetime', 'temperature', 'depth_temperature'])
oxygen_POSE  = aquatics.query("site_id == 'POSE'").filter(items=['datetime', 'oxygen', 'depth_oxygen'])
temp_POSE
series_tP = TimeSeries.from_dataframe(temp_POSE, time_col = 'datetime', value_cols='temperature', fill_missing_dates=True, freq='D')
series_oP = TimeSeries.from_dataframe(oxygen_POSE, time_col = 'datetime', value_cols='oxygen', fill_missing_dates=True, freq='D')
```
